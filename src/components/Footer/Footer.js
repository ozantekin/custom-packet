    ...
    return(
        <footer className="py-10 lg:py-20 px-7 lg:px-[144px] bg-[#262626] text-[#ffff] flex items-center justify-center flex-col">
            <section className="flex items-center justify-between gap-8 lg:flex-row flex-col">
                   ...
                   <div className="lg:mr-[87px]">
                       ...
                       <div>
                           <form className="flex items-center justify-center gap-4">
                               ...
                               <button type="submit" className="font-semibold hover:bg-transparent shadow-xl hover:text-[#ffff] text-black bg-[#ffff] p-4 rounded-full transition duration-500 ease-in-out outline-0">Gönder</button>
                           </form>
                ...
                <div className="lg:w-1/2 mb-12 lg:mb-0 flex items-start justify-start w-full lg:justify-between lg:flex-row flex-col">
                    <nav className="grid grid-cols-2 grid-rows-3 mb-16 lg:mb-0 gap-7">
                        <div>
                            <p>
                                Paketler
                            </p>
